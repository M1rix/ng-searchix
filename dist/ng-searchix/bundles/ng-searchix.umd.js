  ...
  ***************************************************************************** */
  ...
  var SearchixDialogComponent = /** @class */ (function () {
      function SearchixDialogComponent(data, cdr) {
          ...
          this.recents = [];
          this.activeIndex = 0;
          this.metaKey = ((_a = this.data.config.hotkeyLabel) === null || _a === void 0 ? void 0 : _a.startsWith('⌘')) ? '⌘' : 'ctrl';
  ...
  var SearchixComponent = /** @class */ (function () {
      ...
      SearchixComponent.prototype.onKeyDown = function (e) {
          var _a, _b, _c;
          var hk = ((_c = (_a = this.hotkey) !== null && _a !== void 0 ? _a : (_b = this.defaultConfig) === null || _b === void 0 ? void 0 : _b.hotkey) !== null && _c !== void 0 ? _c : 'ctrl+k');
